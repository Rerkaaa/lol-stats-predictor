...
.scorecard-match-panel .analysis-columns{position:absolute!important;left:31.5%!important;top:0!important;width:68.5%!important;height:36px;align-items:center;gap:14px!important;grid-template-columns:50px 78px 94px 65px 54px minmax(0,1fr)!important}
.scorecard-match-panel .analysis-columns span:nth-child(2){transform:translateX(13px)}
.scorecard-match-panel .analysis-columns span:nth-child(3){transform:translateX(25px)}
.scorecard-match-panel .analysis-columns span:nth-child(4){transform:translateX(45px)}
.scorecard-match-panel .analysis-columns span:nth-child(5),.scorecard-match-panel .analysis-columns span:nth-child(6){transform:translateX(52px)}
